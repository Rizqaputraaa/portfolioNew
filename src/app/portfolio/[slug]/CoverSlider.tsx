...
export default function CoverSlider({ images, title }: Props) {
  ...
  // Click to open lightbox (only if no drag happened)
  ...
  return (
    <>
      ...
      >
        ...
        {total > 1 && (
          <>
            <button className={`${styles.sliderBtn} ${styles.sliderBtnPrev}`} onClick={e => { e.stopPropagation(); prev(); }} aria-label="Previous">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                <polyline points="15 18 9 12 15 6" />
              </svg>
            </button>
            <button className={`${styles.sliderBtn} ${styles.sliderBtnNext}`} onClick={e => { e.stopPropagation(); next(); }} aria-label="Next">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
